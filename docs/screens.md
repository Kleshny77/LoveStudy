...
Краткая карта: какой экран за что отвечает и где лежит код. Удобно править вручную. Общее описание бота и запуск — в [README.md](../README.md); деплой — в [deploy.md](deploy.md).
